...
import { MessageSquare, ArrowRight, Calendar, Clock, User } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Communicate with patients about confirmed appointments</p>
        </div>
        ...
        {conversations.length === 0 ? (
          <div className="bg-white rounded-squircle shadow-soft p-12 text-center">
            ...
            <p className="text-gray-400 text-sm">
              Messages will appear here once patients have confirmed appointments with you.
            </p>
            <button
          ...
          <div className="space-y-4">
            {conversations.map((conversation) => (
              <div
                ...
                onClick={() => navigate(`/doctor/messages/${conversation.appointment._id}`)}
                  ...
                  <div className="flex-1">
                    ...
                    {conversation.unreadCount?.doctor > 0 && (
                      <span className="ml-16 mt-2 inline-block bg-primary-600 text-white text-xs px-2 py-1 rounded-full">
                        {conversation.unreadCount.doctor} unread
                      </span>
                    )}
                  </div>
...
export default DoctorMessagesList;
