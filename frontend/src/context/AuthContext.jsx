...
const register = async (data, role) => {
  try {
    ...
    // ✅ ALWAYS use authAPI.register for unified registration with email verification
    ...
    // ✅ IMPORTANT: For registration with email verification,
    // we DON'T log the user in automatically
    // They need to verify their email first
    
    if (responseData.statusCode === 201 || responseData.message) {
